...
u8 display_sprite(u8 sprite_w, u8 sprite_h, u8 sprite_x, u8 sprite_y,
					...
					u8 filp_h, u8 flip_v, u8 priority){
	...
	return template_instanciate_forward_search(&icon_template, sprite_x, sprite_y, priority);
}
...
u8 display_compressed_sprite_compressed_pal(u8 sprite_w, u8 sprite_h, u8 sprite_x, u8 sprite_y,
								u16 tiles_tag, void *ptr_to_tile,
								u16 pals_tag,  void *ptr_to_pal,
								u8 filp_h, u8 flip_v){
...
u8 display_npc(u8 oam_id, u8 sprite_x, u8 sprite_y, u8 tiles_tag){
	...
	return display_sprite(oam->width, oam->height, sprite_x, (oam->height == 0x10 ? sprite_y +8 : sprite_y),
						  ...
						  oam->palTag, findOamPalEntryByTag(oam->palTag)->pal_ptr, 0, 0, 2);
}
